        ...
        <div className="skills-container">
            ...
            <div className="skills-grid">
                ...
                <div className="skill">
                    ...
                    <h3>AI/ML & Data</h3>
                    <p>Traditional ML—classification, clustering, regression—plus RAG, LLM, and NLP for AI-powered workflows. Operational and product analytics with Splunk, ELK, Grafana, Adobe Analytics, Tableau, and SQL.</p>
                    <div className="flex-chips">
                        <span className="chip-title">Tech stack:</span>
