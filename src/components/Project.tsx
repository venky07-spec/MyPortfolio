    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <p className="project-impact"><strong>Impact:</strong></p>
                <ul>
            ...
            <div className="project">
                ...
                <p>Led product and rollout of call-deflection and enrollment initiatives: Easy Fill and refill-by-text programs, plus client copay assistance campaigns including Saveon and Foundational Program enrollments. Campaigns and in-flow prompts moved routine refills, order updates, and copay support from the call center to self-serve digital and SMS. Outcomes include reduced inbound volume and stronger digital adoption so patients get greater convenience and affordability.</p>
                <p className="project-impact"><strong>Impact:</strong></p>
                <ul>
                    <li>45% call volume reduction</li>
                    <li>60% increased digital adoption</li>
                    <li>Improved patient experience and outcomes</li>
                </ul>
            </div>
            <div className="project">
